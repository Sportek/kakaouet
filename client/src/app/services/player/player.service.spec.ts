...
describe('PlayerService', () => {
  ...
  beforeEach(() => {
    ...
    players = [
      {
          name: 'Alice', score: 5, interactionStatus: InteractionStatus.finalized, role: GameRole.Organisator, isExcluded: false, isMuted: false,
          hasGiveUp: false
      },
      { name: 'Bob', score: 7, interactionStatus: InteractionStatus.interacted, role: GameRole.Organisator, isExcluded: false, isMuted: false,
      hasGiveUp: false },
      { name: 'Charlie', score: 5, interactionStatus: InteractionStatus.noInteraction, role: GameRole.Organisator, isExcluded: false, isMuted: false,
      hasGiveUp: false }
    ];
  });
